...
const CareerCards = ({ profileData, isVisible }) => {
      ...
      <div className="max-w-7xl mx-auto">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {(career.keySkills || ['Technical Skills', 'Communication', 'Problem Solving']).map((skill, skillIndex) => (
                        <span
                          key={skillIndex}
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <p className="text-green-700 font-semibold">
                      {career.growthPotential || "₹5-12 LPA • High Growth Potential"}
                    </p>
                  </div>
                </div>
        ...
        {careers.length > 0 && (
          <div className="text-center mt-12">
            <button
              onClick={generateCareerRecommendations}
              className="px-8 py-3 bg-gradient-to-r from-green-500 to-blue-600 text-white rounded-lg font-semibold hover:from-green-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105"
            >
